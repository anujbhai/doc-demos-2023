  ...
  endpoints: (builder) => ({
    getNotifications: builder.query({
      ...
      async onCacheEntryAdded(
        arg,
        { updateCachedData, cacheDataLoaded, cacheEntryRemoved, dispatch }, // eslint-disable-line
      ) {
...
export const selectNotificationsResult = // eslint-disable-line
...
export const fetchNotificationsWebsocket = () => (dispatch, getState) => {
  ...
  // Hard code a call to mock server to simulate a server push scenario
  // over web  sockets
